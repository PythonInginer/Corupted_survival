...
class CursedGrass(pygame.sprite.Sprite):
    def __init__(self):
        super(CursedGrass, self).__init__()
        self.image = pygame.image.load("data/materials/cursed_grass.png")
        self.image = pygame.transform.scale(self.image, (50, 50))
        self.rect = self.image.get_rect()
        self.field_x = -1
        self.field_y = -1
        self.name = "cursed grass"
